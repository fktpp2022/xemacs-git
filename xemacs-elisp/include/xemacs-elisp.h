...
Lisp_Object make_string_from_buffer (struct buffer *, Bytebpos, Bytecount);
Lisp_Object make_string_from_buffer_no_extents (struct buffer *, Bytebpos, Bytecount);
