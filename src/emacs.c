...
*/ );
  Vexec_path = Qnil;
  dump_mark_nil_lisp_object (&Vexec_path);
...
*/ );
  ...
  dump_mark_nil_lisp_object (&Vexec_directory);
...
*/ );
  ...
  dump_mark_nil_lisp_object (&Vdata_directory);
...
*/ );
  ...
  dump_mark_nil_lisp_object (&Vsite_directory);
...
*/ );
  Vdoc_directory = Qnil;
  dump_mark_nil_lisp_object (&Vdoc_directory);
