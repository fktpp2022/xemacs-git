...
# Set font rendering type for summary
if(HAVE_X_WINDOWS)
  set(X11_FONT_RENDERING "core X11 fonts")
  if(HAVE_XFT)
    set(X11_FONT_RENDERING "Xft")
  elseif(USE_XFONTSET)
    set(X11_FONT_RENDERING "X FontSet (XFS)")
  endif()

  # Set menubar type with font tech
  if(HAVE_MENUBARS)
    set(X11_MENUBARS_TYPE "${XEMACS_WITH_MENUBARS_TYPE}")
    if(HAVE_XFT_MENUBARS)
      set(X11_MENUBARS_TYPE "${X11_MENUBARS_TYPE} (Xft)")
    elseif(USE_XFONTSET)
      set(X11_MENUBARS_TYPE "${X11_MENUBARS_TYPE} (XFS)")
    endif()
  endif()
endif()
